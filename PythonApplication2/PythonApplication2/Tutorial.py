...
whiskas_model = pulp.LpProblem('The Whiskas Problem', pulp.LpMaximize)
...
salt = dict(zip(ingredients, [0.002, 0.005, 0.007, 0.008, 0.000, 0.002]))
#note these are constraints and not an objective as there is a equality/inequality
whiskas_model += sum([x[i] for i in ingredients]) == 100.0
